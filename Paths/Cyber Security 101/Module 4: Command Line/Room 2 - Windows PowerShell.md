Link: https://tryhackme.com/room/windowspowershell (Premium Room)

![image](https://github.com/user-attachments/assets/b6e1b720-3f35-49b9-bc7f-1126319a9105)

Discover the "Power" in PowerShell and learn the basics.

**Module 1: Introduction**

Ahoy there! If you’re here, you’ve either heard whispers of the marvels of PowerShell and want to discover more, or you’ve sailed over from the first room of the Command Line module—[Windows Command Line](https://tryhackme.com/room/windowscommandline). Either way, you’re about to embark on a journey to discover the marvels of this powerful shell, learning how to use it to uncover the secrets of any Windows system. Avast, then—on board!
...
1. Learn what PowerShell is and its capabilities.
   
2. Understand the basic structure of PowerShell’s language.
   
3. Learn and run some basic PowerShell commands.
   
4. Understand PowerShell’s many applications in the cyber security industry.

Room Prerequisites: 

Before approaching this room, it’s recommended that you have understood the concepts in the [Windows and AD Fundamentals](https://tryhackme.com/module/windows-and-active-directory-fundamentals) module and the [Windows Command Line](https://tryhackme.com/room/windowscommandline) room.
...
1. Start Menu: Type powershell in the Windows Start Menu search bar, then click on Windows PowerShell or PowerShell from the results.
   
2. Run Dialog: Press Win + R to open the Run dialog, type powershell, and hit Enter.
   
3. File Explorer: Navigate to any folder, then type powershell in the address bar, and press Enter. This opens PowerShell in that specific directory.
   
4. Task Manager: Open the Task Manager, go to File > Run new task, type powershell, and press Enter.
...
![2](https://github.com/user-attachments/assets/4065c98e-04b0-4a31-a84c-000ccc17be34)
...
Command : `Get-Alias echo`

![Screenshot from 2025-06-30 17-44-01](https://github.com/user-attachments/assets/e7dcf94b-9df6-477f-824c-938f2522bd75)
...
**Module 4: Navigating the File System and Working with Files**
...
![Screenshot from 2025-07-01 16-26-24](https://github.com/user-attachments/assets/132afd11-66b3-4a35-82ec-da3d772b8fdd)

------------------------------------------------------------------------------------------------------------------------------------------------

**Module 5: Piping, Filtering, and Sorting Data**
...
1. `-ne`: "not equal". This operator can be used to exclude objects from the results based on specified criteria.
   
2. `-gt`: "greater than". This operator will filter only objects which exceed a specified value. It is important to note that this is a strict comparison, meaning that objects that are equal to the specified value will be excluded from the results.
   
3. `-ge`: "greater than or equal to". This is the non-strict version of the previous operator. A combination of -`gt` and `-eq`.
   
4. `-lt`: "less than". Like its counterpart, "greater than", this is a strict operator. It will include only objects which are strictly below a certain value.

5. `-le`: "less than or equal to". Just like its counterpart -ge, this is the non-strict version of the previous operator. A combination of `-lt` and `-eq`.
...
**Module 6: System and Network Information**
...
![Screenshot from 2025-07-01 16-59-43](https://github.com/user-attachments/assets/d928c63c-b98a-4bf5-856e-7106549402d5)
...
We find ourselves in `C:\Users\Captain` and we need to go the `Users` directory. To do this we use the command `Set-Location ..` and in Users directory we list the files using `Get-ChildItem`

![Screenshot from 2025-07-01 17-13-40](https://github.com/user-attachments/assets/03ad84a1-94d4-4a46-b5b0-d88c8a3506d9)

And we need to use the command  `Set-Location .\p1r4t3\` (we got this user from previous questions) and list the items inside this directory

![Screenshot from 2025-07-01 17-16-34](https://github.com/user-attachments/assets/6604d5ba-41de-4ec4-8ccc-dc288b1ca2aa)

And we find a hidden directory among the other directories called `hidden-treasure-chest` and we get into this and find a file called `big-treasure.txt` we read this file using `Get-Content`

![Screenshot from 2025-07-01 17-20-13](https://github.com/user-attachments/assets/fe4fb358-3938-49ab-b029-16e7ab0d2574)

**Cmdlets used (in sequence)**

```
PS C:\Users\captain> Set-Location ..
...
PS C:\Users> Set-Location .\p1r4t3\
PS C:\Users\p1r4t3> Get-ChildItem
...
PS C:\Users\p1r4t3> Set-Location .\hidden-treasure-chest\
...
**Module 7: Real-Time System Analysis**
...
Cmdlet used: `Get-FileHash .\big-treasure.txt`

![Screenshot from 2025-07-01 17-29-32](https://github.com/user-attachments/assets/d497d5f1-8a7c-41d6-927b-59a3a1c4e64f)
...
We know that the shady guy's motto is  `A merry life and a short one` and we need to find the name of a service which has the same motto as this shady guy

For that we use this cmdlet `Get-Service | Where-Object -Property "DisplayName" -like "A merry life and a short one*"`

And we get a particular service and that is our answer

![Screenshot from 2025-07-01 17-42-16](https://github.com/user-attachments/assets/1ef2d10c-ea6e-46aa-a853-9c910d68488e)
...
What is the syntax to execute Invoke-Command -ComputerName RoyalFortune -ScriptBlock { Get-Service }the command Get-Service on a remote computer named "RoyalFortune"? Assume you don't need to provide credentials to establish the connection. [for the sake of this question, avoid the use of quotes (" or ') in your answer]
...
To continue building up your command line skills, proceed to the [Linux Command Line](https://tryhackme.com/room/linuxshells) room, up next in the module.

**Answer the questions below**

I'm ready to go on to the next adventure!
