Link: https://tryhackme.com/room/linuxshells (Premium Room)

![image](https://github.com/user-attachments/assets/4d832d26-a90d-498d-9cf3-5906c82f263d)

Learn about scripting and the different types of Linux shells.

**Module 1: Introduction to Linux Shells**
...
_Who is the facilitator between the user and the OS?_

Answer: `Shell`

--------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Module 2: How To Interact With a Shell?**

 SSH credentials below:
```
Username : user
...
Most Linux distributions use _**`Bash` (Bourne Again Shell)**_ as their default shell. However, the default shell displayed when you open the terminal depends on your Linux distribution.
...
_What is the default shell in most Linux distributions?_

Answer: `Bash`

_Which command utility is used to list down the contents of a directory?_

Answer: `ls`

_Which command utility can help you search for anything in a file?_

Answer: `grep`

--------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Module 3: Types of Linux Shells**
...
1. Bash is a widely used shell with scripting capabilities.
  
2. It offers a tab completion feature, which means if you are in the middle of completing a command, you can press the tab key on your keyboard. It will automatically complete the command based on a possible match or give you multiple suggestions for completing it.
  
3. Bash keeps a history file and logs all of your commands. You can use the up and down arrow keys to use the previous commands without typing them again. You can also type `history` to display all your previous commands.
...
1. It offers a very simple syntax, which is feasible for beginner users.
  
2. Unlike bash, it has auto spell correction for the commands you write.

3. You can customize the command prompt with some cool themes using fish.

4. The syntax highlighting feature of fish colors different parts of a command based on their roles, which can improve the readability of commands. It also helps us to spot errors with their unique colors.

5. Fish also provides scripting, tab completion, and command history functionality like the shells mentioned in this task.
...
1. Zsh provides advanced tab completion and is also capable of writing scripts.
   
2. Just like fish, it also provides auto spell correction for the commands.

3. It offers extensive customization that may make it slower than other shells.

4. It also provides tab completion, command history functionality, and several other features.
...
| Scripting           | It offers widely compatible scripting with extensive documentation.  | It has limited scripting features as compared to the other two shells.                 | It offers excellent scripting, combining traditional Bash capabilities with extra features. |
| Tab completion      | It has a basic tab completion feature.                               | It offers advanced tab completion with suggestions based on previous commands.         | Its tab completion can be extended heavily using plugins.                                |
| Customization       | Basic level of customization.                                        | It offers good customization through interactive tools.                                | Advanced customization through the oh-my-zsh framework.                                  |
| User friendliness   | Less user-friendly, but familiar to many due to wide usage.          | The most user-friendly shell.                                                          | Can be highly user-friendly with proper customization.                                   |
| Syntax highlighting | Syntax highlighting is not available.                               | Built-in syntax highlighting.                                                          | Syntax highlighting is available via plugins.                                             |
...
_Which shell comes with syntax highlighting as an out-of-the-box feature?_

Answer: `Fish`

_Which shell does not have auto spell correction?_

Answer: `Bash`

_Which command displays all the previously executed commands of the current session?_

Answer: `history`

--------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Module 4: Shell Scripting and Components**
...
_**A shebang (#!) tells the system which interpreter to use to run the script; without it, the script may not execute properly or may require manual invocation with the interpreter (e.g., bash script.sh).**_
...
_What is the shebang used in a Bash script?_

Answer: `#!/bin/bash`

_Which command gives executable permissions to a script?_

Answer: `chmod +x`

_Which scripting functionality helps us configure iterative tasks?_

Answer: `loops`

---------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Module 5: The Locker Script**
...
![image](https://github.com/user-attachments/assets/7577963e-afe2-4969-801d-0dc7436cd50a)
...
_What would be the correct PIN to authenticate in the locker script?_
...
**_Practicals Explanation:_**

1. We use _**`sudo su`**_ and we will be in as a root user and name of the script which we are editing is `flag_hunt.sh` in `/home/user` 

![script](https://github.com/user-attachments/assets/900f4597-9639-4672-997c-37cc3369e01a)
  
2. First we add _**`/var/log`**_ to the variable `directory` as mentioned above

3. Second we add _**`thm-flag01-script`**_ to the variable `flag` as mentioned above

4. Third, we replace `" "/*.log` with  **_`"$directory"/*.log`_**

![change](https://github.com/user-attachments/assets/e67e9486-190d-45c6-9317-fb10a162d8bb)


5. Now when we run this script, we get output which contains the location of the file which contains the flag

![flag_loc](https://github.com/user-attachments/assets/620e9c82-8651-434a-b15c-39a507d63c35)


6. We will open that file and get the flag

![cat](https://github.com/user-attachments/assets/289ba76f-11e2-46d9-8514-53c6a25cae65)


   
**Answer the questions below**

_Which file has the keyword?_ (Name of the file which contains the flag)

Answer: `authentication.log`

_Where is the cat sleeping?_ (Flag inside the file)
