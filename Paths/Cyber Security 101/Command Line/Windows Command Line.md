...
![image](https://github.com/user-attachments/assets/6e0fc356-a8bf-4b85-855f-0666ce3851f8)
...
1. Lower resource usage: CLIs require fewer system resources than graphics-intensive GUIs. In other words, you can run your CLI system on older hardware or systems with limited memory. If you are using cloud computing, your system will require lower resources, which in turn will lower your bill.
 
2. Automation: While you can automate GUI tasks, creating a batch file or script with the commands you need to repeat is much easier.
   
3. Remote management: CLI makes it very convenient to use SSH to manage a remote system such as a server, router, or an IoT device. This approach works well on slow network speeds and systems with limited resources.
...
![image](https://github.com/user-attachments/assets/c27ef90f-1f56-4c3a-bc86-300502d54a05)
...
![Screenshot from 2025-06-29 19-09-08](https://github.com/user-attachments/assets/eed6a2d0-df90-4b60-99cc-be7d23cea31f)


![Screenshot from 2025-06-29 19-09-13](https://github.com/user-attachments/assets/c5c12c79-e62b-4e06-89ae-f60574ed8554)
...
![1](https://github.com/user-attachments/assets/19ca4c8c-b09e-44da-81b2-5e0f262604ce)

![2](https://github.com/user-attachments/assets/f8d23ca6-0b82-45f0-86e5-a3e8f9cf9fbb)

![3](https://github.com/user-attachments/assets/45c04964-0a51-4806-add8-be490711893a)

![4](https://github.com/user-attachments/assets/7f4b0d64-571a-4e0a-938a-c268f5b23d6e)
...
![Screenshot from 2025-06-29 19-28-15](https://github.com/user-attachments/assets/7f93f915-59c9-4dd0-a73c-2c4a2d902f15)
...
`tasklist /svc /FI "PID eq 976"`

![Screenshot from 2025-06-29 20-50-01 (1)](https://github.com/user-attachments/assets/790bc057-6bdc-4998-aaad-3a057e514c7c)
...
First we try to read the contents of the file using the command `type C:\Treasure\Hunt` but we get access denied

![1](https://github.com/user-attachments/assets/1ab485bb-db23-4527-9ce0-78aa197136dd)

Now we copy the contents of the file to a new file 

![2](https://github.com/user-attachments/assets/430ab266-25da-4e9f-9833-ce402c5a9553)

Now we can read the new file (copy) and get the flag
...
Now that you know the Windows command line, it is time to move to the [Windows PowerShell](https://tryhackme.com/room/windowspowershell) room.
...
Type `shutdown /? | more` in the terminal and we see an option `shutdown /r` in the list for restart

![Screenshot from 2025-06-30 16-52-48](https://github.com/user-attachments/assets/ecc0553f-d3e2-46a6-93ca-945f0294a49c)
