...
![image](https://github.com/user-attachments/assets/27a19c6c-5390-47ec-988f-70a91ab945b4)
...
This room expects that you know terms such as IP address and TCP port number; however, we don’t expect that the reader is able to explain such terms in proper technical depth. If you are unfamiliar with these terms, please consider joining the [Pre Security](https://tryhackme.com/path/outline/presecurity) path.
...
![image](https://github.com/user-attachments/assets/d8cb72da-b74d-41c3-9f2c-c17170da5a81)
...
![image](https://github.com/user-attachments/assets/ebf4565e-4378-455a-9f33-98c72c289b8d)
...
![5f04259cf9bf5b57aed2c476-1719849271800](https://github.com/user-attachments/assets/fa10cbc5-6566-4983-a418-c97696379077)
...
![image](https://github.com/user-attachments/assets/e4d45194-529d-417e-a673-edf57b7bd96f)
...
![image](https://github.com/user-attachments/assets/24a5e2b5-77d2-4fe0-a46a-ab6791b3e748)
...
_Which layer is responsible for end-to-end communication between running applications?_

Answer: `4`

_Which layer is responsible for routing packets to the proper network?_

Answer: `3`

_In the OSI model, which layer is responsible for encoding the application data?_

Answer: `6`

_Which layer is responsible for transferring data between hosts on the same network segment?_
...
| 6            | Presentation Layer   | Application Layer         | SSL/TLS, MIME, JPEG, GIF, PNG, MPEG, ASCII, EBCDIC  |
| 5            | Session Layer        | Application Layer         | NetBIOS, RPC, PPTP                                  |
| 4            | Transport Layer      | Transport Layer           | TCP, UDP                                            |
| 3            | Network Layer        | Internet Layer            | IP (IPv4/IPv6), ICMP, IPSec                         |
| 2            | Data Link Layer      | Link Layer                | Ethernet (802.3), WiFi (802.11), ARP, PPP           |
| 1            | Physical Layer       | Link Layer                | Ethernet cables, Fiber optics, Radio frequencies    |
...
_To which layer does HTTP belong in the TCP/IP model?_

Answer: `Application Layer`

_How many layers of the OSI model does the application layer in the TCP/IP model cover?_

Answer: `3`

---------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Module 4: IP Addresses and Subnets**
...
![image](https://github.com/user-attachments/assets/68061f97-2b37-4db2-9068-9256254a7b4f)
...
![image](https://github.com/user-attachments/assets/32986206-0928-4923-8bee-73617d12db30)
...
- **_SYN_** Packet: The client initiates the connection by sending a SYN packet to the server. This packet contains the client’s randomly chosen initial sequence number.

- **_SYN-ACK_** Packet: The server responds to the SYN packet with a SYN-ACK packet, which adds the initial sequence number randomly chosen by the server.

- **_ACK_** Packet: The three-way handshake is completed as the client sends an ACK packet to acknowledge the reception of the SYN-ACK packet.

![image](https://github.com/user-attachments/assets/60e1e8f4-88b4-484e-9674-c54e81828e08)
...
_Which protocol requires a three-way handshake?_

Answer: `TCP`

_What is the approximate number of port numbers (in thousands)?_
...
- **_Application data_**: It all starts when the user inputs the data they want to send into the application. For example, you write an email or an instant message and hit the send button. The application formats this data and starts sending it according to the application protocol used, using the layer below it, the transport layer.

- **_Transport protocol segment or datagram_**: The transport layer, such as TCP or UDP, adds the proper header information and creates the TCP segment (or UDP datagram). This segment is sent to the layer below it, the network layer.

- **_Network packet_**: The network layer, i.e. the Internet layer, adds an IP header to the received TCP segment or UDP datagram. Then, this IP packet is sent to the layer below it, the data link layer.

- **_Data link frame_**: The Ethernet or WiFi receives the IP packet and adds the proper header and trailer, creating a frame.
...
![image](https://github.com/user-attachments/assets/643dcfc8-6b89-45f8-950b-8f606a09a54a)
...
_On a WiFi, within what will an IP packet be encapsulated?_

Answer: `Frame`

_What do you call the UDP data unit that encapsulates the application data?_

Answer: `Datagram`

_What do you call the data unit that encapsulates the application data sent over TCP?_
...
- **_Echo server_**: This server echoes everything you send it. By default, it listens on port 7.

- **_Daytime server_**: This server listens on port 13 by default and replies with the current day and time.

- **_Web (HTTP) server_**: This server listens on TCP port 80 by default and serves web pages.
...
_Use `telnet` to connect to the web server on `MACHINE_IP`. What is the name and version of the HTTP server?_

Answer: `lighttpd/1.4.63`

**_Explanation:_**

Type `telnet MACHINE_IP 80` in your terminal and once we see "Escape Characters" line we type in `GET / HTTP/1.1` followed by `Host: telnet.thm` on next line and we click `Enter` and see the following response

![image](https://github.com/user-attachments/assets/0df8b82b-b9f2-43c7-ae0e-53487f1bff5b)


_What flag did you get when you viewed the page?_

![image](https://github.com/user-attachments/assets/f92dc155-86ad-4e02-af09-80fc7eb9f554)
...
Now that you have finished Networking Concepts, it is time to join [Networking Essentials](https://tryhackme.com/room/networkingessentials).

**Answer the questions below**

_Please note and remember all the concepts, network layers, and protocols explained in this room._
