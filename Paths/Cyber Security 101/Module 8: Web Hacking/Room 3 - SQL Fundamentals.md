Link: https://tryhackme.com/room/sqlfundamentals (Premium Room)

<img width="1200" height="1200" alt="image" src="https://github.com/user-attachments/assets/5391725a-1382-4769-a9f6-b868e093b05f" />
...
1. _Teach me the basics of SQL!_

Answer: No answer needed

---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Module 2: Databases 101**
...
<img width="1140" height="800" alt="image" src="https://github.com/user-attachments/assets/3a9660ba-961b-4201-b2bd-5ebceff5bb53" />
...
<img width="1140" height="800" alt="image" src="https://github.com/user-attachments/assets/6065b2cf-fa00-4e1b-bd5d-8960cf89c2a0" />
...
<img width="2050" height="690" alt="image" src="https://github.com/user-attachments/assets/a7400b9a-8e51-4d97-880a-e3e4fcef93a1" />
...
1. _What type of database should you consider using if the data you're going to be storing will vary greatly in its format?_

Answer: `Non-relational database`

2. _What type of database should you consider using if the data you're going to be storing will reliably be in the same structured format?_

Answer: `relational database`

3. _In our example, once a record of a book is inserted into our "Books" table, it would be represented as a ___ in that table?_

Answer: `row`

4. _Which type of key provides a link from one table to another?_

Answer: `foreign key`

5. _which type of key ensures a record is unique within a table?_
...
<img width="1140" height="800" alt="image" src="https://github.com/user-attachments/assets/702a07b8-22ad-492e-a534-ceff0b9add82" />
...
- **_It's fast_**: Relational databases (aka those that SQL is used for) can return massive batches of data almost instantaneously due to how little storage space is used and high processing speeds. 

- **_Easy to Learn_**: Unlike many programming languages, SQL is written in plain English, making it much easier to pick up. The highly readable nature of the language means users can concentrate on learning the functions and syntax.

- **_Reliable_**: As mentioned before, relational databases can guarantee a level of accuracy when it comes to data by defining a strict structure into which data sets must fall in order to be inserted.

- **_Flexible_**: SQL provides all kinds of capabilities when it comes to querying a database; this allows users to perform vast data analysis tasks very efficiently.

**Getting Hands ON**

<img width="1140" height="800" alt="image" src="https://github.com/user-attachments/assets/c427e9ef-ae97-4df7-afd0-aefc2dc71e8c" />
...
1. _What serves as an interface between a database and an end user?_

Answer: `DBMS`

2. _What query language can be used to interact with a relational database?_

Answer: `SQL`

----------------------------------------------------------------------------------------------------------------------------------------------

**Module 4: Database and Table Statements**
...
1. _Using the statement you've learned to list all databases, it should reveal a database with a flag for a name; what is it?_

Answer: `THM{575a947132312f97b30ee5aeebba629b723d30f9}`

**_Explanation:_**

We type `show databases;` and we see a flag

<img width="607" height="413" alt="image" src="https://github.com/user-attachments/assets/b5c718d2-67cf-4d61-aa9b-0381d8ad4250" />

2. _In the list of available databases, you should also see the  task_4_db database. Set this as your active database and list all tables in this database; what is the flag present here?_

Answer: `THM{692aa7eaec2a2a827f4d1a8bed1f90e5e49d2410}`

**_Explanation:_**

We type `show databases;` and we see a databse called `task_4_db`

<img width="607" height="413" alt="image" src="https://github.com/user-attachments/assets/b5c718d2-67cf-4d61-aa9b-0381d8ad4250" />

Now we use `use task_4_db` 

<img width="814" height="161" alt="image" src="https://github.com/user-attachments/assets/a69b68b2-b0ba-4ea4-8360-f55bbf953f17" />

Now we use `show tables` and we see the flag

<img width="630" height="179" alt="image" src="https://github.com/user-attachments/assets/e9983cf7-8940-4ab7-a455-e663c78a08e4" />
...
- **_Create (INSERT statement)_** - Adds a new record to the table.

- **_Read (SELECT statement)_** - Retrieves record from the table.

- **_Update (UPDATE statement)_** - Modifies existing data in the table.

- **_Delete (DELETE statement)_** - Removes record from the table.

These operations enable us to effectively manage and manipulate data within a database.

**Answer the questions below**

1. _Using the tools_db database, what is the name of the tool in the hacking_tools table that can be used to perform man-in-the-middle attacks on wireless networks?_

Answer: `Wi-Fi Pineapple`

**_Explanation:_**

We use the command `use tools_db;`

<img width="810" height="178" alt="image" src="https://github.com/user-attachments/assets/6839b794-2c46-4660-908d-0e00b4e180aa" />

Now we use `select * from hacking_tools;` and we see id 3 has the name of the tool

<img width="975" height="540" alt="image" src="https://github.com/user-attachments/assets/2122c28e-a030-4817-92b0-eb6e708ef41f" />

2. _Using the tools_db database, what is the shared category for both USB Rubber Ducky and Bash Bunny?_
...
Now we use `select * from hacking_tools;` and we see id 4 has the category name
...
1. _Using the tools_db database, what is the total number of distinct categories in the hacking_tools table?_
...
And now we use `select count(distinct(category)) from hacking_tools` and get the answer

<img width="717" height="194" alt="image" src="https://github.com/user-attachments/assets/d78acdf3-1819-41a7-bba1-142991029e5a" />

2. _Using the tools_db database, what is the first tool (by name) in ascending order from the hacking_tools table?_

Answer: `Bash Bunny`

**_Explanation:_**

We use `select name from hacking_tools order by name asc;` and we can see the name of the tool at the top

<img width="695" height="361" alt="image" src="https://github.com/user-attachments/assets/aff50007-11dd-45ba-b7d9-e79d98e55060" />

3. _Using the tools_db database, what is the first tool (by name) in descending order from the hacking_tools table?_

Answer: `Wi-Fi Pineapple`

**_Explanation:_**

We use `select name from hacking_tools order by name desc;` and we can see the name of the tool at the top

<img width="706" height="357" alt="image" src="https://github.com/user-attachments/assets/6f8b3601-cc96-4983-b5ff-742b100fdf98" />
...
1. _Using the tools_db database, which tool falls under the Multi-tool category and is useful for pentesters and geeks?_
...
<img width="245" height="91" alt="image" src="https://github.com/user-attachments/assets/cb014470-4694-4a3b-ac40-0b8998ca1cba" />

Now with the query `select name from hacking_tools where category like "%Multi-tool%";` we get the name of the tool

<img width="902" height="200" alt="image" src="https://github.com/user-attachments/assets/0c616b2e-bd10-4d87-931f-e907774c6fe8" />

2. _Using the tools_db database, what is the category of tools with an amount greater than or equal to 300?_

Answer: `RFID cloning`

**_Explanation:_**

We use the query  `select category from hacking_tools where amount >=300`

<img width="741" height="211" alt="image" src="https://github.com/user-attachments/assets/7107b684-bf5a-4744-9710-cbf61bebe5c6" />


3. _Using the tools_db database, which tool falls under the Network intelligence category with an amount less than 100?_

Answer: `Lan Turtle`

**_Explanation:_**

We use the query  `select name from hacking_tools where category ='Network Intelligence' and amount < 100;`

<img width="972" height="216" alt="image" src="https://github.com/user-attachments/assets/847fdb03-21f4-42f7-a438-7d7a94c26080" />
...
1. _Using the tools_db database, what is the tool with the longest name based on character length?_
...
And Now we use the query `select name from hacking_tools where length(name) =(select max(length(name)) from hacking_tools);`

<img width="974" height="197" alt="image" src="https://github.com/user-attachments/assets/0b2b9bec-37af-4259-bd8e-abb544da149c" />

2. _Using the tools_db database, what is the total sum of all tools?_

Answer: `1444`

**_Explanation:_**

We the query `select sum(amount) from hacking_tools;`

<img width="548" height="183" alt="image" src="https://github.com/user-attachments/assets/695e2d90-fe79-47f8-9a18-fa5321cdc6fe" />


3. _Using the tools_db database, what are the tool names where the amount does not end in 0, and group the tool names concatenated by " & "._

Answer: `Flipper Zero & iCopy-XS`

**_Explanation:_**

We use the command `SELECT GROUP_CONCAT(CONCAT(name, '&', amount)) AS tools FROM hacking_tools WHERE SUBSTRING(amount, LENGTH(amount), 1) != '0';`

<img width="960" height="274" alt="image" src="https://github.com/user-attachments/assets/b6302a1f-e4fb-4ce2-a96d-337233b964a4" />
...
1. _I'm ready to move forward and learn more about web application security._
