...
<img width="1201" height="1200" alt="image" src="https://github.com/user-attachments/assets/fdd3db58-644d-4250-8018-828702e071e0" />
...
MD5 and SHA1 have been attacked and are now considered insecure due to the ability to engineer hash collisions. However, no attack has yet given a collision in both algorithms simultaneously, so if you compare the MD5 and SHA1 hash, you will see that they’re different. You can view the MD5 collision example on the MD5 Collision Demo page; furthermore, you can read the details of the SHA1 collision attack at [Shattered](https://shattered.io/). Due to these, you shouldn’t trust either algorithm for hashing passwords or data.

**Answer the questions below**

1. _What is the SHA256 hash of the `passport.jpg` file in `~/Hashing-Basics/Task-2`?_

Answer: `77148c6f605a8df855f2b764bcc3be749d7db814f5f79134d2aa539a64b61f02`

**_Explanation:_**

We click on Start Machine and then we `cd` to `~/Hashing-Basics/Task-2`

<img width="912" height="76" alt="image" src="https://github.com/user-attachments/assets/420f1ae8-0552-4237-a683-2e2fde368d0a" />

And now we generate a hash for the file `passport.jpg`  using the command below

`sha256sum passport.jpg`

<img width="906" height="185" alt="image" src="https://github.com/user-attachments/assets/318b9838-d41d-4b53-9e35-3b14015edf2f" />

2. _What is the output size in bytes of the MD5 hash function?_

Answer: `16`

**_Explanation:_**

First we use the following command to generate a md5 hash

`md5sum passport.jpg`

And now we count the number of hexadecimal digits and we get 32 and we divide it by 2 and 32/2 = 16

<img width="917" height="102" alt="image" src="https://github.com/user-attachments/assets/a8498576-820c-4613-b6d0-e878f1b8f209" />

3. _If you have an 8-bit hash output, how many possible hash values are there?_

Answer: `256`

**_Explanation:_**

Since 2^number_of_bits = 2^8 = 256

---------------------------------------------------------------------------------------------------------------------------------------------

**Module 3: Insecure Password Storage for Authentication**
...
1. _What is the 20th password in `rockyou.txt?`_
...
We use the following command to get the password

`head -n 20 /usr/share/wordlists/rockyou.txt`

where:

- head -> displays the top most content in a file

- n20 -> displays first 20 lines

- /usr/share/wordlists/rockyou.txt -> is the path of rockyou.txt

and we can see the 20th password is `qwerty`

<img width="913" height="568" alt="image" src="https://github.com/user-attachments/assets/751c1b41-1af7-4f88-8a78-a42cb5ba07c8" />

----------------------------------------------------------------------------------------------------------------------------------------------

**Module 4: Using Hashing for Secure Password Storage**
...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/494ad43e-9643-4160-9db3-032507b9d0f6" />
...
1. _Manually check the hash “4c5923b6a6fac7b7355f53bfe2b8f8c1” using the rainbow table above._

Answer: `inS3CyourP4$$`

**_Explanation:_**

From the above given rainbow table (in the lesson) we can see the hash `4c5923b6a6fac7b7355f53bfe2b8f8c1` and the password is `inS3CyourP4$$`

2. _Crack the hash “5b31f93c09ad1d065c0491b764d04933” using an online tool._

Answer: `tryhackme`

**_Explanation:_**

We visit https://hashes.com and type the hash and enter the valid captca and we can see the password as `tryhackme`

<img width="701" height="367" alt="image" src="https://github.com/user-attachments/assets/e3c7135d-67e6-4fc3-b59f-4d586d990745" />

3. _Should you encrypt passwords in password-verification systems? Yea/Nay_

Answer: `Nay`

**_Why?_**

Because we need a key and we should also store the key separately and securely 

-----------------------------------------------------------------------------------------------------------------------------------------------

**Module 5: Recognising Password Hashes**
...
| `$2b$, $2y$, $2a$, $2x$` | bcrypt is a hash based on the Blowfish block cipher, supported on various Unix-like systems         |
| `$6$`          | sha512crypt is a hash based on SHA-2 with 512-bit output, commonly used on older Linux systems                |
...
1. _What is the hash size in yescrypt?_

Answer: `256`

**_Explanation:_**

We type the command `man 5 crypt` and scrolling down we see `yescrypt` and it's hash size

<img width="907" height="575" alt="image" src="https://github.com/user-attachments/assets/f4ab66a2-ba1b-4e44-8559-b1f8c708da54" />

2. _What’s the Hash-Mode listed for Cisco-ASA MD5?_

Answer: `2410`

**_Explanation:_**

We visit the page https://hashcat.net/wiki/doku.php?id=example_hashes and search for `Cisco-ASA MD5` and we can see the hash mode as 2410

<img width="672" height="92" alt="image" src="https://github.com/user-attachments/assets/bb0f0b80-3eaf-4b40-9c23-f9280a89f693" />

3. _What hashing algorithm is used in Cisco-IOS if it starts with `$9$`?_

Answer: `scrypt`

**_Explanation:_**

We visit the page https://hashcat.net/wiki/doku.php?id=example_hashes and search for `Cisco-IOS $9$` and we can see the scrypt 

<img width="792" height="102" alt="image" src="https://github.com/user-attachments/assets/14e5259e-0a27-4434-b608-b80280697171" />
...
1. _Use `hashcat` to crack the hash, `$2a$06$7yoU3Ng8dHTXphAg913cyO6Bjs3K5lBnwq5FJyA6d01pMSrddr1ZG`, saved in `~/Hashing-Basics/Task-6/hash1.txt`._

Answer: `85208520`

_**Explanation:**_

We use the command below and get the password

`hashcat -m 3200 -a 0 hash1.txt /usr/share/wordlists/rockyou.txt`

<img width="901" height="625" alt="image" src="https://github.com/user-attachments/assets/9fb3f039-c5a8-4d74-97a1-33f206d72185" />

2. _Use hashcat to crack the SHA2-256 hash, 9eb7ee7f551d2f0ac684981bd1f1e2fa4a37590199636753efe614d4db30e8e1, saved in saved in ~/Hashing-Basics/Task-6/hash2.txt._

Answer: `halloween`

**_Explanation:_**

We use this command below and get the password

`hashcat -m 1400 -a 0 hash2.txt /usr/share/wordlists/rockyou.txt`

<img width="901" height="611" alt="image" src="https://github.com/user-attachments/assets/09f75ab4-45b7-4750-a7ff-1e0fd80c2854" />

3. _Use hashcat to crack the hash, $6$GQXVvW4EuM$ehD6jWiMsfNorxy5SINsgdlxmAEl3.yif0/c3NqzGLa0P.S7KRDYjycw5bnYkF5ZtB8wQy8KnskuWQS3Yr1wQ0, saved in ~/Hashing-Basics/Task-6/hash3.txt._
...
<img width="906" height="631" alt="image" src="https://github.com/user-attachments/assets/b5937c14-61f8-44cc-a571-b6ba07c4f22d" />

4. _Crack the hash, b6b0d451bbf6fed658659a9e7e5598fe, saved in ~/Hashing-Basics/Task-6/hash4.txt._

Answer: `funforyou`

**_Explanation_**

We visit https://crackstation.net/ and then type the hash and we get the password

<img width="1097" height="409" alt="image" src="https://github.com/user-attachments/assets/78128f6c-b585-47c5-8ae6-e3c114d74b67" />

------------------------------------------------------------------------------------------------------------------------------------------------

**Module 7: Hashing for Integrity Checking**
...
<img width="440" height="500" alt="image" src="https://github.com/user-attachments/assets/f5bc15e5-651e-43a7-9c68-1cbb771cd6a2" />
...
1. _What is SHA256 hash of libgcrypt-1.11.0.tar.bz2 found in ~/Hashing-Basics/Task-7?_

Answer: `09120c9867ce7f2081d6aaa1775386b98c2f2f246135761aae47d81f58685b9c`

**_Explanation:_**

We will use the command below and can see our answer

`sha256sum libgcrypt-1.11.0.tar.bz2`

<img width="910" height="196" alt="image" src="https://github.com/user-attachments/assets/ff255b85-b37d-4378-bf50-2ed12fd176de" />


2. _What’s the hashcat mode number for HMAC-SHA512 (key = $pass)?_

Answer: `1750`

**_Explanation:_**

We go to this website https://hashcat.net/wiki/doku.php?id=example_hashes and search for `HMAC-SHA512 (key = $pass)` and we see 1750 as hash mode

<img width="1227" height="45" alt="image" src="https://github.com/user-attachments/assets/94781788-ce93-4406-812f-6935fdafc06f" />
...
1. _Use base64 to decode RU5jb2RlREVjb2RlCg==, saved as decode-this.txt in ~/Hashing-Basics/Task-8. What is the original word?_

Answer: `ENcodeDEcode`

**_Explantion:_**

We cd to  `~/Hashing-Basics/Task-8/` and now we use the following command to decode base64 file

`base64 -d decode-this.txt` and we get the answer

<img width="916" height="181" alt="image" src="https://github.com/user-attachments/assets/707877dd-f9f4-4625-8f2e-5d13b1c1d9e5" />

2. _Ensure you have noted the various concepts and tools explored in this room._
