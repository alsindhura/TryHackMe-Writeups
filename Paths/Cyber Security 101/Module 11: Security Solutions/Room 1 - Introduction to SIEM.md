...
<img width="600" height="600" alt="image" src="https://github.com/user-attachments/assets/81fa8c92-88fa-4cca-aff2-abcc5c28dbaf" />
...
1. _What does SIEM stand for?_

Answer: `Security Information and Event Management system`

---

**Module 2: Network Visibility through SIEM**
...
<img width="921" height="801" alt="image" src="https://github.com/user-attachments/assets/7e92b9ee-8e25-42f7-aff9-54d86b90a204" />
...
**_2) Network-Centric Log Sources_**
...
<img width="733" height="729" alt="image" src="https://github.com/user-attachments/assets/f40507fe-09fb-4e74-9816-3d23a182a064" />
...
1. _Is Registry-related activity host-centric or network-centric?_

Answer: `host-centric`

2. _Is VPN related activity host-centric or network-centric?_

Answer: `network-centric`

---

**Module 3: Log Sources and Log Ingestion**
...
<img width="1813" height="995" alt="image" src="https://github.com/user-attachments/assets/7e1134b4-1154-4b7e-969f-98d2f1db46a2" />
...
<img width="850" height="561" alt="image" src="https://github.com/user-attachments/assets/ded926f5-b4f5-463d-8de7-de1812ebd3a3" />
...
1) **_Agent / Forwarder_**: These SIEM solutions provide a lightweight tool called an agent (forwarder by Splunk) that gets installed in the Endpoint. It is configured to capture all the important logs and send them to the SIEM server.

2) **_Syslog_**: Syslog is a widely used protocol to collect data from various systems like web servers, databases, etc., are sent real-time data to the centralized destination.

3) **_Manual Upload_**: Some SIEM solutions, like Splunk, ELK, etc., allow users to ingest offline data for quick analysis. Once the data is ingested, it is normalized and made available for analysis.

4) **_Port-Forwarding_**: SIEM solutions can also be configured to listen on a certain port, and then the endpoints forward the data to the SIEM instance on the listening port.

An example of how Splunk provides various methods for log Ingestion is shown below:

<img width="1397" height="436" alt="image" src="https://github.com/user-attachments/assets/7569d385-08d9-4ea7-a8b7-4a3aede6121d" />

**Answer the questions below**

1. _In which location within a Linux environment are HTTP logs stored?_
...
<img width="879" height="801" alt="image" src="https://github.com/user-attachments/assets/84540b52-aefb-4a73-a9ac-2bf731b17a19" />
...
1. _Read the task above._

Answer: No answer needed

---

**Module 5: Analysing Logs and Alerts**
...
<img width="1904" height="977" alt="image" src="https://github.com/user-attachments/assets/499fb408-b756-4ae4-80d7-20b9f30dc057" />
...
1. _Which Event ID is generated when event logs are removed?_

Answer: `104`

2. _What type of alert may require tuning?_
...
1. _Click on Start Suspicious Activity, which process caused the alert?_

Answer: `cudominer.exe`

**_Explanation:_**

We click on View Site and see something called "Start Suspicious Activity" and we click on this button

<img width="1019" height="895" alt="image" src="https://github.com/user-attachments/assets/3e34df36-3521-44ca-b357-f7452011f07d" />

We see that the alert is caused by

<img width="1025" height="889" alt="image" src="https://github.com/user-attachments/assets/73fb5578-52dc-4952-a865-e46ea39d2827" />


2. _Find the event that caused the alert, which user was responsible for the process execution?_

Answer: `chris.fort`

**_Explanation:_**

We click on the popping alert and we will see events dashboard and here we can find the event is triggered by

<img width="842" height="571" alt="siem" src="https://github.com/user-attachments/assets/7bc6d89e-fa04-43f5-b8d4-9f9ac28bfb40" />

3. _What is the hostname of the suspect user?_

Answer: `HR_02`

**_Explanation:_**

We see that the user chris.fort has the host name 

<img width="840" height="576" alt="siem(1)" src="https://github.com/user-attachments/assets/1b0d7c3d-15c5-4d02-89a8-c2a06353c5b8" />


4. _Examine the rule and the suspicious process; which term matched the rule that caused the alert?_

Answer: `miner`

**_Explanation:_**

We click on the log and would be navigated to eventID dashboard and there we can see the rule as miner

<img width="836" height="400" alt="image" src="https://github.com/user-attachments/assets/150507d3-fdc8-4dac-9c3f-204e5b4f1cee" />


5. _What is the best option that represents the event? Choose from the following:_
...
Now we click on "Go to Analysis section" and see

<img width="838" height="396" alt="image" src="https://github.com/user-attachments/assets/52cb6356-8a8d-48a1-bc49-1ba6e0ac68ef" />

Since it is a crypto miner activity we choose 

<img width="835" height="397" alt="image" src="https://github.com/user-attachments/assets/c95881eb-da37-4082-a934-9a829521a593" />

6. _Selecting the right ACTION will display the FLAG. What is the FLAG?_

Answer: `THM{000_SIEM_INTRO}`

**_Explanation:_**

After choosing the option, we click on `Save Action` and get the flag

<img width="838" height="397" alt="image" src="https://github.com/user-attachments/assets/6fdaccf2-762d-4e0d-adc4-1e2d008a2017" />
