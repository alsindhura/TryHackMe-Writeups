...
![image](https://github.com/user-attachments/assets/dacca23c-629e-49a4-8b6a-b44f5cb70800)
...
Your First Hack We will use a command-line application called "Gobuster" to brute-force FakeBank's website to find hidden directories and pages. Gobuster will take a list of potential page or directory names and try accessing a website with each of them; if the page exists, it tells you.
...
![image](https://github.com/user-attachments/assets/d53a6911-55f7-4452-be03-0ba272ae476f)
...
![image](https://github.com/user-attachments/assets/485a1317-dc1b-484c-93bc-17beb36f3f07)
...
![image](https://github.com/user-attachments/assets/2a607c13-e959-4607-b784-77cc73944c57)
...
_Above your account balance, you should now see a message indicating the answer to this question. Can you find the answer you need?_

Answer: Type `bank-transfer` in the URL space

![image](https://github.com/user-attachments/assets/9778d816-5282-4ec5-856c-b18dea4b0256)
...
![image](https://github.com/user-attachments/assets/e5c94657-ece0-46ee-b2e2-b9c5fe9091b8)


It should show Successful transfer. Refer the screenshot below:

![image](https://github.com/user-attachments/assets/ff6fda28-6f81-4e64-981f-0b42a3566841)
...
![image](https://github.com/user-attachments/assets/1954e604-cb7c-472b-a266-d9456f642015)
...
_Read the above, and continue with the next room!_
